...
## Datasets 
본 연구에서는 자체 제작한 3D 프린팅 스마트폰 현미경을 활용하여 11명의 피험자로부터 총 114장의 손톱 하부 모세혈관 원본 이미지를 획득하였습니다.
...
- **Preprocessing:** 1mm 기준 너비인 645x180 pixels 크기로 고정하고, 분석 정확도를 높이기 위해 Grayscale 변환을 수행.
...
- 서버 : 네트워크 server.py를 통해 서버를 켜둡니다.
